...
function SideBar(){
    ...
    return (
        <div className="sidebar">
            <ul>
                <li className="all-games link">
                    <Link to='games' style={underlineTxt}>All Games</Link>
                </li>
                <li>
                    <ul className="new-releases">New Releases
                        <li className="last-30-days link">
                            <Link to="/shop/last-30-days" style={underlineTxt}>
                                <div className="last-30-days-icon icon">
                                ...
                                <div className="last-30-days-txt">Last 30 days</div>
                            </Link>
                        </li>
                        <li className="this-week link">
                            <Link to="/shop/this-week" style={underlineTxt}>
                                <div className="this-week-icon icon">
                                ...
                                <div className="this-week-txt">This Week</div>
                            </Link>
                        </li>
                        <li className="next-week link">
                            <Link to="/shop/next-week" style={underlineTxt}>
                                <div className="next-week-icon icon">
                                ...
                                <div className="next-week-txt">Next week</div>
                            </Link>
                        </li>
                    </ul>        
                </li>
                <li>
                    <ul className="top">Top
                        <li className="best-of-year link">
                            <Link to="/shop/best-of-year" style={underlineTxt}>
                                <div className="best-of-year-icon icon">
                                ...
                                <div className="best-of-year-txt">
                                    Best of the Year
                                </div>
                                
                            </Link>
                        </li>
                        <li className="popular-last-year link">
                            <Link to="/shop/popular-last-year" style={underlineTxt}>
                                <div className="popular-last-year-icon icon">
                                ...
                                <div className="popular-last-year-txt">Popular in {lastyr}</div>
                            </Link>
                        </li>
                        <li className="all-time-top link">
                            <Link to="/shop/all-time-top" style={underlineTxt}>
                                <div className="all-time-top-icon icon">
                                ...
                                <div className="all-time-top-txt">All Time Top</div>
                            </Link>
                        </li>
                    </ul>        
                </li>
